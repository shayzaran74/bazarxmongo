---
description: "BazarX B2B (Ticari Takas) Ekosistemi Audit Planı ve Surplus modülü kuralları."
globs: "apps/backend/src/modules/barter/**/surplus*.ts, apps/backend/src/modules/barter/domain/entities/surplus*.ts"
---
