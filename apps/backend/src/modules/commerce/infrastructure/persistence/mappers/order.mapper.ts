...
export class OrderMapper {
  ...
  public static toResponse(domain: Order): Record<string, unknown> {
    ...
    return {
      ...
      discountAmount: mongoose.Types.Decimal128.fromString(String(props.discountAmount)),
      shippingCost: mongoose.Types.Decimal128.fromString(String(props.shippingCost)),
      paidWithXP: mongoose.Types.Decimal128.fromString(String(props.paidWithXP)),
      paidWithCash: mongoose.Types.Decimal128.fromString(String(props.paidWithCash)),
  ...
  public static toPersistence(domain: Order): Record<string, unknown> {
    ...
    const result: Record<string, unknown> = {
      ...
      totalAmount: mongoose.Types.Decimal128.fromString(String(props.totalAmount)),
      paymentMethod: props.paymentMethod,
      paymentStatus: props.paymentStatus,
      vendorStatus: props.vendorStatus,
      buyerStatus: props.buyerStatus,
      ...
      items: props.items?.map(item => {
        ...
        return {
          ...
          listingId: itemProps.listingId,
          quantity: itemProps.quantity,
          price: mongoose.Types.Decimal128.fromString(String(itemProps.price)),
          totalAmount: mongoose.Types.Decimal128.fromString(String(itemProps.totalAmount)),
          productName: itemProps.productName,
          productImages: itemProps.productImages,
          variantInfo: itemProps.variantInfo,
        };
