    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isLoggedIn)) {
        ...
        if (unref(avatarUrl)) {
          ...
          _push(`<span>${ssrInterpolate(((_a = unref(fullName)) == null ? void 0 : _a.charAt(0).toUpperCase()) || "U")}</span>`);
        }
      ...
      if (unref(isLoggedIn)) {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(`<span class="text-xs font-black tracking-tight uppercase"${_scopeId}>Y\xF6netici Paneli</span>`);
              } else {
                return [
                  createVNode(_component_Icon, {
                    name: "heroicons:cog-6-tooth",
                  ...
                  createVNode("span", { class: "text-xs font-black tracking-tight uppercase" }, "Y\xF6netici Paneli")
                ];
              }
            }),
            _: 1
        ...
        _push(`<span class="text-xs font-black tracking-tight">G\xFCvenli \xC7\u0131k\u0131\u015F</span></button></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`S\u0131k\xE7a Sorulanlar`);
          } else {
            return [
              createTextVNode("S\u0131k\xE7a Sorulanlar")
            ];
          }
        }),
        _: 1
      ...
      _push(`</li></ul></div></div><div class="pt-10 border-t border-gray-50 flex flex-col md:flex-row justify-between items-center gap-6"><p class="text-[10px] font-black text-gray-400 uppercase tracking-widest">\xA9 2026 BAZARX. T\xDCM HAKLARI SAKLIDIR.</p><div class="flex items-center space-x-1 grayscale opacity-50"><div class="px-2 py-1 bg-gray-100 rounded text-[9px] font-bold">VISA</div><div class="px-2 py-1 bg-gray-100 rounded text-[9px] font-bold">MASTERCARD</div><div class="px-2 py-1 bg-gray-100 rounded text-[9px] font-bold">IYZICO</div></div></div></div></footer><nav class="lg:hidden fixed bottom-4 left-4 right-4 h-16 bg-dark-950/90 backdrop-blur-xl rounded-[2rem] shadow-2xl border border-white/10 flex items-center justify-around px-2 z-[600]">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="text-[8px] font-black uppercase tracking-widest"${_scopeId}>\xDCr\xFCnler</span>`);
          } else {
            return [
              createVNode(_component_Icon, {
                name: "heroicons:rectangle-group",
              ...
              createVNode("span", { class: "text-[8px] font-black uppercase tracking-widest" }, "\xDCr\xFCnler")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=default-CcnFQNKj.mjs.map
