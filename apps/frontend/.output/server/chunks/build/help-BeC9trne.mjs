...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div><h1 class="text-4xl lg:text-5xl font-display font-black text-dark-950 italic mb-6"> Yard\u0131m Merkezi </h1><p class="text-gray-500 text-lg max-w-md mx-auto mb-10 leading-relaxed"> Sorular\u0131n\u0131za h\u0131zl\u0131 yan\u0131t alabilece\u011Finiz yard\u0131m merkezi i\xE7eri\u011Fimiz yak\u0131nda haz\u0131r olacak. </p>`);
...
//# sourceMappingURL=help-BeC9trne.mjs.map
