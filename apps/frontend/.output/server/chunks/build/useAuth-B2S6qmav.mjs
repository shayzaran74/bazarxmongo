  ...
  actions: {
    ...
    async register(input) {
      ...
      try {
        ...
        const error = err;
        this.error = ((_a = error.data) == null ? void 0 : _a.message) || "Kay\u0131t s\u0131ras\u0131nda hata olu\u015Ftu.";
        return false;
      } finally {
        this.loading = false;
      }
    ...
    async login(input) {
      ...
      try {
        ...
        const error = err;
        this.error = ((_a = error.data) == null ? void 0 : _a.message) || "Giri\u015F s\u0131ras\u0131nda hata olu\u015Ftu.";
        return false;
      } finally {
        this.loading = false;
      }
...
//# sourceMappingURL=useAuth-B2S6qmav.mjs.map
