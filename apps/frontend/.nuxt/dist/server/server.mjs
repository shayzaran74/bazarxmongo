import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, computed, nextTick, onScopeDispose, watch, toRefs, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, Fragment, createVNode, Text, Suspense, mergeProps, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/macbook/Desktop/bazarx/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/macbook/Desktop/bazarx/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/macbook/Desktop/bazarx/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, getRequestHeaders, getRequestHeader, setCookie, getCookie, deleteCookie } from "/Users/macbook/Desktop/bazarx/node_modules/.pnpm/h3@1.15.11/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "/Users/macbook/Desktop/bazarx/node_modules/.pnpm/defu@6.1.7/node_modules/defu/dist/defu.mjs";
import { klona } from "/Users/macbook/Desktop/bazarx/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs";
import { parse as parse$1 } from "/Users/macbook/Desktop/bazarx/node_modules/.pnpm/cookie-es@2.0.1/node_modules/cookie-es/dist/index.mjs";
import destr from "/Users/macbook/Desktop/bazarx/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs";
import { isEqual as isEqual$1 } from "/Users/macbook/Desktop/bazarx/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs";
...
const unhead_4u7UCHvDA8YCBWRhu2Urs7w_KereGkDB4s63w9__84k = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "faq",
    path: "/faq",
    component: () => import("./_nuxt/faq-uGQeJ6TV.js")
  },
  {
    name: "cart",
    path: "/cart",
    component: () => import("./_nuxt/cart-BDHHIGLR.js")
  },
  {
    name: "help",
    path: "/help",
    component: () => import("./_nuxt/help-DDNiYJN6.js")
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$3 || {},
    component: () => import("./_nuxt/index-BkGVm-VZ.js")
  },
  {
    name: "barter",
    path: "/barter",
    component: () => import("./_nuxt/barter-ByKU8HWy.js")
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-u72_OA3x.js")
  },
  {
    name: "premium",
    path: "/premium",
    component: () => import("./_nuxt/premium-CVZU1Odw.js")
  },
  {
    name: "profile",
    path: "/profile",
    meta: { "middleware": ["auth"] },
    component: () => import("./_nuxt/profile-BIGDlHVb.js"),
    children: [
      {
        name: "profile-addresses",
        path: "addresses",
        meta: { "middleware": ["auth"] },
        component: () => import("./_nuxt/addresses-CG16onxM.js")
      }
    ]
  },
  {
    ...
    component: () => import("./_nuxt/login-CwGN_3lv.js")
  },
  {
    name: "legal-kvkk",
    path: "/legal/kvkk",
    component: () => import("./_nuxt/kvkk-Do6mw6uI.js")
  },
  {
    name: "legal-terms",
    path: "/legal/terms",
    component: () => import("./_nuxt/terms-BHmak3fC.js")
  },
  {
    name: "auth-success",
    path: "/auth/success",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/success-DD6HjmHE.js")
  },
  {
    name: "auth-register",
    path: "/auth/register",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/register-BbfwYPDQ.js")
  },
  {
    name: "legal-privacy",
    path: "/legal/privacy",
    component: () => import("./_nuxt/privacy-Bm5VzAXu.js")
  },
  {
    name: "products",
    path: "/products",
    component: () => import("./_nuxt/index-B-mc_pzn.js")
  },
  {
    name: "products-slug",
    path: "/products/:slug()",
    component: () => import("./_nuxt/_slug_-CIhfxLTr.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-CMr2mqx1.js")
};
...
const revive_payload_server_8wQJTlaqCxPONxPagLRODbhBOMnZQz1eA_1j61GrjXA = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/Icon-D5PWnCnx.js").then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-BzW5Z3ER.js").then((r) => r["default"] || r.default || r));
...
const normalizedLocales = [
  {
    ...
    "files": [
      {
        "path": "/Users/macbook/Desktop/bazarx/apps/frontend/locales/tr.json"
      }
    ]
  }
];
...
const switch_locale_path_ssr_niTEzyPuUraDDzR2RmS8ftwfQIKObfMMFoMT11pXOv4 = /* @__PURE__ */ defineNuxtPlugin({
...
const i18n_DoUFXWV6LnxRosC_SK_Bj2CtWyhMaRdzR8GWTtTaSGc = /* @__PURE__ */ defineNuxtPlugin({
  name: "i18n:plugin",
...
const plugins = [
  unhead_4u7UCHvDA8YCBWRhu2Urs7w_KereGkDB4s63w9__84k,
  plugin$1,
  revive_payload_server_8wQJTlaqCxPONxPagLRODbhBOMnZQz1eA_1j61GrjXA,
  plugin,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4,
  switch_locale_path_ssr_niTEzyPuUraDDzR2RmS8ftwfQIKObfMMFoMT11pXOv4,
  i18n_DoUFXWV6LnxRosC_SK_Bj2CtWyhMaRdzR8GWTtTaSGc
];
const layouts = {
  auth: defineAsyncComponent(() => import("./_nuxt/auth-DWw0BiML.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-CitKXmkd.js").then((m) => m.default || m))
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased" }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Ct1vHaoX.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-E6B68P2O.js"));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.2_@emnapi+core@1.9.2_@emnapi+runtime@1.9.2_@parcel+watcher@2.5.6_@types+node@20.19._vprfopv77pl74cvuztsqqrmssq/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.2_@emnapi+core@1.9.2_@emnapi+runtime@1.9.2_@parcel+watcher@2.5.6_@types+node@20.19._vprfopv77pl74cvuztsqqrmssq/node_modules/nuxt/dist/app/components/nuxt-root.vue");
