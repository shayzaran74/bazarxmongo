...
import { u as useHead } from "./v3-BANJyGfz.js";
...
import "/Users/macbook/Desktop/bazarx/node_modules/.pnpm/@unhead+vue@2.1.13_vue@3.5.32_typescript@5.9.3_/node_modules/@unhead/vue/dist/index.mjs";
const _sfc_main = {
  __name: "error-500",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-7112d43f><div class="-bottom-1/2 fixed h-1/2 left-0 right-0 spotlight" data-v-7112d43f></div><div class="max-w-520px text-center" data-v-7112d43f><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-7112d43f>${ssrInterpolate(__props.status)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-7112d43f>${ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.2_@emnapi+core@1.9.2_@emnapi+runtime@1.9.2_@parcel+watcher@2.5.6_@types+node@20.19._vprfopv77pl74cvuztsqqrmssq/node_modules/nuxt/dist/app/components/error-500.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error500 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7112d43f"]]);
export {
  error500 as default
};
//# sourceMappingURL=error-500-CXeDRz8j.js.map
