...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div><h1 class="text-4xl lg:text-5xl font-display font-black text-dark-950 italic mb-6"> Ürünler </h1><p class="text-gray-500 text-lg max-w-md mx-auto mb-10 leading-relaxed"> Geniş ürün kataloğumuz ve akıllı eşleşme sistemimiz çok yakında hizmetinizde olacak. </p>`);
...
//# sourceMappingURL=index-CnndH9Bd.js.map
