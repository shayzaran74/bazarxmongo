...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div><h1 class="text-4xl lg:text-5xl font-display font-black text-dark-950 italic mb-6"> Hukuki Metinler </h1><p class="text-gray-500 text-lg max-w-md mx-auto mb-10 leading-relaxed"> Sözleşmeler ve Gizlilik Politikası metinlerimiz hazırlanıyor. </p>`);
...
//# sourceMappingURL=terms-CfWzuCJ_.js.map
