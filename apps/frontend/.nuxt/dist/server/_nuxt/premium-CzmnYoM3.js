...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><h1 class="text-4xl lg:text-5xl font-display font-black text-dark-950 italic mb-6"> Çok Yakında </h1><p class="text-gray-500 text-lg max-w-md mx-auto mb-10 leading-relaxed"> Sizlere daha iyi bir deneyim sunmak için bu sayfa üzerinde çalışmalarımız devam ediyor. Çok yakında buradayız! </p>`);
...
//# sourceMappingURL=premium-CzmnYoM3.js.map
