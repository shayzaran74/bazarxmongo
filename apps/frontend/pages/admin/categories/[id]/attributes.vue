  ...
  <div>
      ...
      <div class="flex items-center justify-between">
        <div>
          <h2 class="text-2xl font-bold text-gray-900">
            {{ category?.name || 'Yükleniyor...' }} - Özellikler
          </h2>
          <p class="mt-1 text-sm text-gray-500">
            Bu kategoriye ait ürün özelliklerini tanımlayın (Beden, Renk, Malzeme vb.)
          </p>
        </div>
        <button
    ...
    >
      ...
      <p class="text-gray-500 mb-4">
        Bu kategoriye özellik ekleyerek vendor'ların ürün eklerken doldurması gereken
        alanları belirleyin.
      </p>
      <button
        class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700"
          ...
          >
            ...
            <td class="px-6 py-4">
              <div class="flex flex-wrap gap-1">
                ...
                <span
                  v-if="attr.isVariant"
                  class="px-2 py-0.5 text-xs bg-orange-100 text-orange-800 rounded"
                >Varyant</span>
                <span
      ...
      <div class="bg-white rounded-lg max-w-xl w-full max-h-[90vh] overflow-y-auto">
        <div class="px-6 py-4 border-b border-gray-200">
          <h3 class="text-lg font-medium text-gray-900">
            {{ editingAttribute ? 'Özelliği Düzenle' : 'Yeni Özellik' }}
          </h3>
        </div>
        <form
          class="px-6 py-4"
          ...
          <div class="space-y-4">
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  type="text"
                  required
                  placeholder="Beden, Renk, Dolgu Tipi..."
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  required
                  placeholder="beden, renk, dolgu_tipi..."
                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                >
                <p class="text-xs text-gray-500 mt-1">
                  Sistem içi kullanım için (küçük harf, alt çizgi)
                </p>
              </div>
            </div>
            ...
            <div v-if="['select', 'multiselect'].includes(attrForm.type)">
              ...
              <input
                ...
                type="text"
                placeholder="S, M, L, XL veya Pamuk, Polyester..."
                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
              >
              <p class="text-xs text-gray-500 mt-1">
            ...
            <div class="border-t border-gray-200 pt-4 space-y-3">
              <label class="flex items-center">
                ...
                <span class="ml-2 text-xs text-gray-500">(Vendor mutlaka doldurmalı)</span>
              </label>

              <label class="flex items-center">
                <input
                  v-model="attrForm.isVariant"
                  type="checkbox"
                  class="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                >
                <span class="ml-2 text-sm text-gray-900">Stok Varyantı</span>
                <span class="ml-2 text-xs text-gray-500">(Her seçenek için ayrı stok)</span>
              </label>
              ...
              <label class="flex items-center">
                ...
                <span class="ml-2 text-xs text-gray-500">(Ürün listesinde filtre olarak görünür)</span>
              </label>
...
const fetchCategory = async () => {
    try {
        const response = await $api(`/api/v1/admin/categories/${categoryId}`)
