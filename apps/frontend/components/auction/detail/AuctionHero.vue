<template>
  <div class="relative h-[450px] lg:h-[550px] overflow-hidden bg-[#0f172a] italic">
    ...
    <div class="relative z-10 max-w-7xl mx-auto h-full px-4 flex flex-col items-center justify-center text-center">
      ...
      <h1 class="text-5xl md:text-8xl font-black text-white mb-10 uppercase tracking-tightest leading-[0.9] drop-shadow-2xl">
        {{ auction?.title }}
      </h1>

      <!-- Countdown Grid -->
      <div v-if="auction?.status === 'Active'" class="flex gap-4 md:gap-10 mb-12">
