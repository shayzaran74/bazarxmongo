  ...
  <div class="flex flex-col lg:flex-row gap-6">
    ...
    <div class="flex-1 space-y-8 pb-24 text-black">
      ...
      <ProductFormBasics
        ...
        v-model:selected-sub-category1="selectedSubCategory1"
        v-model:selected-sub-category2="selectedSubCategory2"
        :found-catalog-product="foundCatalogProduct"
        :is-editing="isEditing"
        :main-categories="mainCategories"
        :sub-categories1="subCategories1"
        :sub-categories2="subCategories2"
