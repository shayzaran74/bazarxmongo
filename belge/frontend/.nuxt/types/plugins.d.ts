...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../plugins/apiConfig.client").default> &
  InjectionType<typeof import("../../plugins/auth.client").default> &
  InjectionType<typeof import("../../plugins/error-handler").default> &
  InjectionType<typeof import("../../plugins/stripe.client").default> &
  InjectionType<typeof import("../../plugins/toast.client").default>

declare module '#app' {
  interface NuxtApp extends NuxtAppInjections { }

  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt-site-config:init' | 'pinia' | 'nuxt:revive-payload:server' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'i18n:plugin:switch-locale-path-ssr' | 'i18n:plugin' | 'vite-pwa:nuxt:pwa-icons-plugin' | 'nuxt-site-config:i18n' | 'nuxt:chunk-reload' | 'nuxt:checkIfLayoutUsed' | 'vite-pwa:nuxt:client:plugin'
  }
}
