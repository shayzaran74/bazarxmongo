  ...
  <div class="p-8 max-w-4xl mx-auto">
    ...
    <div class="mb-8">
      <h1 class="text-3xl font-bold text-gray-900">
        💼 Barter Borsa Ana Sayfa Ayarları
      </h1>
      <p class="text-gray-600 mt-1">
        Barter Borsa ana sayfasında hangi bölümlerin görüneceğini yönetin
      </p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div class="p-6 space-y-8">
        ...
        >
          ...
          <div class="flex items-center space-x-4">
            <NuxtLink
              to="/admin/settings/side-ads?ecosystem=BARTER_BORSA"
        ...
        >
          ...
          <div class="flex items-center space-x-4">
            <NuxtLink
              to="/admin/banners?ecosystem=BARTER_BORSA"
              class="text-xs font-bold text-primary-600 hover:underline px-3 py-1 bg-white rounded-lg border border-gray-200"
            >
              Bannerları Yönet
            </NuxtLink>
...
const fetchSettings = async () => {
  try {
    ...
    if (response.success) {
      const getVal = (key) => response.data[`barterborsa_${key}`] !== undefined ? response.data[`barterborsa_${key}`] : response.data[key]
