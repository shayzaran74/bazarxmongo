    ...
    <div class="p-4 border-b bg-gradient-to-r from-gray-900 to-gray-800 text-white shrink-0">
      ...
      >
        ...
        <span
          ...
          :class="{
            'bg-green-500/20 text-green-300': room.tradeOffer.status === 'accepted',
            'bg-yellow-500/20 text-yellow-300': room.tradeOffer.status === 'pending',
            'bg-red-500/20 text-red-300': room.tradeOffer.status === 'disputed',
          }"
        >
