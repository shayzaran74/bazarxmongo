        ...
        <tbody class="divide-y">
          ...
          >
            ...
            <td class="px-6 py-4 text-sm font-bold space-x-3">
              <span
                v-if="product.status && PRODUCT_STATUS_CONFIG[product.status]"
                :class="['inline-block px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest mr-2', PRODUCT_STATUS_CONFIG[product.status].class]"
              >
