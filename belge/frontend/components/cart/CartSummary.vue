    ...
    <div class="space-y-4">
      ...
      <div class="border-t border-gray-200 pt-4 flex justify-between text-base font-medium text-gray-900">
        ...
        <div>
          ...
          >
            {{ formatPrice(Math.max(0, summary.totalPrice - (appliedEscrowCoupon.rewardValue || 0))) }}
          </p>
        </div>
      </div>
    </div>
          ...
          <div class="flex-1">
            ...
            >
              ...
              >
                ...
                <span class="text-[10px] font-bold text-green-600 mt-1">-{{ formatPrice(coupon.rewardValue) }} {{ $t('cart.shippingYours') }}</span>
                <button
